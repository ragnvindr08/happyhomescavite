...
const Footer: FC = () => {
  ...
  const policyLinks = [
    ...
    { label: 'About Happy Homes', href: '/about' },
  ];
      ...
      <div className="footer-container">
        ...
        <div className="footer-top">
          <div className="footer-logo-section">
            ...
            />
            <h2 className="footer-brand-name">Happy Homes</h2>
            <p className="footer-description">
              Your trusted community management platform. Connecting residents, 
              managing facilities, and building a better living experience.
            </p>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-contact">
              ...
              <li className="contact-item">
                ...
                <a 
                  href="mailto:happyhomes@gmail.com"
                  style={{ cursor: 'pointer', textDecoration: 'none', color: 'inherit' }}
                >
                  happyhomes@gmail.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            <p className="copyright">
              © {new Date().getFullYear()} Happy Homes. All rights reserved.
            </p>
            <div className="footer-legal">
              {policyLinks.map((link, index) => (
                <React.Fragment key={link.href}>
                  <a href={link.href}>{link.label}</a>
                  {index < policyLinks.length - 1 && <span className="separator">|</span>}
                </React.Fragment>
              ))}
            </div>
          </div>
